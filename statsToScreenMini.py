...
while True:
    ...
    draw.rectangle((0,0,width,height), outline=0, fill=0)
    draw.text((x, top),"Voltage: " + str('{:.3f}'.format(batt_voltage)) + " V",  font=font, fill=255)
    draw.text((x, top+8), "Current: " + str('{:.3f}'.format(batt_current)) + " mA", font=font, fill=255)
    draw.text((x, top+16),"Power: " + str('{:.3f}'.format(batt_power)) + " mW",  font=font, fill=255)
